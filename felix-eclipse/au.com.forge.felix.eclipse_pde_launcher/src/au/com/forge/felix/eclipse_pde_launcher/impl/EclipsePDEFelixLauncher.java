...
public class EclipsePDEFelixLauncher {
	...
	public static void main(String[] args) {
		...
		String enableHook = configProperties.getProperty(Main.SHUTDOWN_HOOK_PROP);
	...
	private static void mergeWithPDELauncherProperties(Properties defaultProperties) {
		...
		try {
			...
			while (keys.hasMoreElements()) {
				...
				if (key.startsWith("felix.auto.")) {
					defaultProperties.put(
					      key,
					      mergeFelixBundleAutoOrInstallString((String) defaultProperties.get(key),
			...
			System.err.println("error while loading PDE felix configuration file: " + e);
			e.printStackTrace();
			// ?!
			// System.exit(1);
		}
	...
	private static String mergeFelixBundleAutoOrInstallString(String toBeExtended, String toExtend) {
